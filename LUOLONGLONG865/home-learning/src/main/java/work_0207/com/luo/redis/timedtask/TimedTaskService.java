...
public class TimedTaskService implements ITimedTaskService{
	...
	public void init() {
		...
		addScript.setScriptSource(
				new ResourceScriptSource(new ClassPathResource("com/luo/spring/redis/timedtask/add.lua")));
		addScript.setResultType(Long.class);
		// unlock script
		batchDelScript = new DefaultRedisScript<Long>();
		batchDelScript.setScriptSource(
				new ResourceScriptSource(new ClassPathResource("com/luo/spring/redis/timedtask/batchdel.lua")));
		...
		querycontentsScript.setScriptSource(
				new ResourceScriptSource(new ClassPathResource("com/luo/spring/redis/timedtask/querycontents.lua")));
