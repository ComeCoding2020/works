...
public class LuaDistributeLock implements ILock {
	...
	public void init() {
		...
		lockScript.setScriptSource(
				new ResourceScriptSource(new ClassPathResource("com/luo/spring/redis/distributedlock/lock/lock.lua")));
		lockScript.setResultType(Long.class);
		// unlock script
		unlockScript = new DefaultRedisScript<Long>();
		unlockScript.setScriptSource(
				new ResourceScriptSource(new ClassPathResource("com/luo/spring/redis/distributedlock/lock/unlock.lua")));
